                        ...
                        return (
                            <Card key={course._id} className="overflow-hidden  hover:shadow-lg transition-shadow    pt-0">
                                ...
                                <CardFooter>
                                    <Button
                                        className="w-full"
                                        onClick={() => setLoadingCourseId(course._id)}
                                        disabled={loadingCourseId === course._id}
                                        asChild={!loadingCourseId || loadingCourseId !== course._id} // Link শুধু তখন child হবে যখন লোড হচ্ছে না
                                    >
                                        {loadingCourseId === course._id ? (
                                            ...
                                            <Link href={`lessons/${course._id}`}>View Details</Link>
                                        )}
                                    </Button>
                                </CardFooter>
